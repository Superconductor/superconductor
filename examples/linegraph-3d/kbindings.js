...
this._gen_allocateHostProxies = function (treeSize) {
	...
	this.fld_generator_childs_rotation_init = this.int_buffer_1.subarray(treeSize * 77, (treeSize * 77) + treeSize);
	this.fld_generator_childs_rotation_last = this.int_buffer_1.subarray(treeSize * 78, (treeSize * 78) + treeSize);
	this.fld_generator_childs_tween_init = this.float_buffer_1.subarray(treeSize * 63, (treeSize * 63) + treeSize);
	this.fld_generator_childs_tween_last = this.float_buffer_1.subarray(treeSize * 64, (treeSize * 64) + treeSize);
	...
	this.fld_generator_childs_valcopy_init = this.float_buffer_1.subarray(treeSize * 65, (treeSize * 65) + treeSize);
	this.fld_generator_childs_valcopy_last = this.float_buffer_1.subarray(treeSize * 66, (treeSize * 66) + treeSize);
	...
	this.fld_generator_childs_yoffset_init = this.int_buffer_1.subarray(treeSize * 79, (treeSize * 79) + treeSize);
	this.fld_generator_childs_yoffset_last = this.int_buffer_1.subarray(treeSize * 80, (treeSize * 80) + treeSize);
