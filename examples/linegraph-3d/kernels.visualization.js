...
this.TOK_GENERATOR = 7; this.TOK_CHILD = 5; this.TOK_ROOT = 9; this.TOK_IGNORE = 8; this.TOK_SPIKE = 11; this.TOK_CHILDS = 6; this.TOK_UNDEFINED = 13; this.TOK_SECOND = 10; this.TOK_TEXTBOX = 12;
// Generated code. Modifcation to this file will be lost on next code generation.
/**
 * @file   cl_runner_generated_buffer_info.h
 * @author Superconductor v0.1
 ...
 * for the node at node_idx.
 */
root_child_minRadius = function  (_ale_arg0) { return _ale_arg0; }
root_child_tweenMin = function  (_ale_arg0) { return _ale_arg0; }
root___draw__ = function  () { return 0; }
root_child_depth = function  (_ale_arg0) { return (_ale_arg0 + 1); }
root_child_height = function  (_ale_arg0) { return _ale_arg0; }
root_child_xOffset = function  (_ale_arg0) { return _ale_arg0; }
root___renderSize__ = function  (_ale_arg1, _ale_arg0) { return (_ale_arg0 + _ale_arg1); }
root_depth = function  () { return 1; }
root_child_tweenMax = function  (_ale_arg0) { return _ale_arg0; }
root___renderRightOffset__ = function  (_ale_arg0) { return _ale_arg0; }
root_child_x = function  (_ale_arg1, _ale_arg0) { return (_ale_arg0 - _ale_arg1); }
...
root_child_yOffset = function  (_ale_arg0) { return _ale_arg0; }
...
root_child_radius = function  (_ale_arg0) { return _ale_arg0; }
root_child_rx = function  (_ale_arg0) { return (5 + _ale_arg0); }
root___childRenderSize__ = function  (_ale_arg0) { return _ale_arg0; }
root_child_rotation = function  (_ale_arg0) { return _ale_arg0; }
root___selfRenderSize__ = function  () { return 0; }
spike___selfRenderSize__3 = function  (_ale_arg6, _ale_arg7, _ale_arg8, _ale_arg2, _ale_arg4, _ale_arg9, _ale_arg0, _ale_arg3, _ale_arg1, _ale_arg5) { return ((((_ale_arg0 != 1) || (_ale_arg1 != 1))) ? 0 : Line3D_size(((((_ale_arg2 + 1.5) + _ale_arg3) + (_ale_arg4 * cos(_ale_arg5))) + (((_ale_arg3 * _ale_arg6) / 1.0) * cos(_ale_arg5))), ((((_ale_arg7 + 1.5) + _ale_arg3) + (_ale_arg4 * sin(_ale_arg5))) + (((_ale_arg3 * _ale_arg6) / 1.0) * sin(_ale_arg5))), (_ale_arg8 * _ale_arg9), ((((_ale_arg2 + 1.5) + _ale_arg3) + (_ale_arg4 * cos(_ale_arg5))) + (((_ale_arg3 * _ale_arg6) / 1.0) * cos(_ale_arg5))), ((((_ale_arg7 + 1.5) + _ale_arg3) + (_ale_arg4 * sin(_ale_arg5))) + (((_ale_arg3 * _ale_arg6) / 1.0) * sin(_ale_arg5))), 0.0, 0.1, rgba(0, 204, 255, 204))); }
spike___renderOffset__ = function  (_ale_arg0, _ale_arg1) { return (_ale_arg0 - _ale_arg1); }
spike___draw__3 = function  (_ale_arg12, _ale_arg13, _ale_arg7, _ale_arg16, _ale_arg3, _ale_arg4, _ale_arg5, _ale_arg0, _ale_arg1, _ale_arg11, _ale_arg14, _ale_arg8, _ale_arg10, _ale_arg15,  _ale_arg2, _ale_arg6, _ale_arg9) { return (((((_ale_arg0 != 1) || (_ale_arg1 != 1))) ? 0 : Line3D_draw(_ale_arg2, (_ale_arg3 + (_ale_arg4 + (_ale_arg5 + _ale_arg6))), _ale_arg7, ((((_ale_arg8 + 1.5) + _ale_arg9) + (_ale_arg10 * cos(_ale_arg11))) + (((_ale_arg9 * _ale_arg12) / 1.0) * cos(_ale_arg11))), ((((_ale_arg13 + 1.5) + _ale_arg9) + (_ale_arg10 * sin(_ale_arg11))) + (((_ale_arg9 * _ale_arg12) / 1.0) * sin(_ale_arg11))), (_ale_arg14 * _ale_arg15), ((((_ale_arg8 + 1.5) + _ale_arg9) + (_ale_arg10 * cos(_ale_arg11))) + (((_ale_arg9 * _ale_arg12) / 1.0) * cos(_ale_arg11))), ((((_ale_arg13 + 1.5) + _ale_arg9) + (_ale_arg10 * sin(_ale_arg11))) + (((_ale_arg9 * _ale_arg12) / 1.0) * sin(_ale_arg11))), 0.0, 0.1, rgba(0, 204, 255, 204))) + _ale_arg16); }
spike___draw__1 = function  (_ale_arg10, _ale_arg11, _ale_arg13, _ale_arg12, _ale_arg5, _ale_arg15, _ale_arg3, _ale_arg0, _ale_arg1, _ale_arg14, _ale_arg9, _ale_arg6, _ale_arg8,  _ale_arg2, _ale_arg4, _ale_arg7) { return (((((_ale_arg0 != 1) || (_ale_arg1 != 1))) ? 0 : Line3D_draw(_ale_arg2, (_ale_arg3 + _ale_arg4), _ale_arg5, ((((_ale_arg6 + 1.5) + _ale_arg7) + (_ale_arg8 * cos(_ale_arg9))) + ((_ale_arg7 * ((_ale_arg10 == 1) ? (1.0 + (_ale_arg11 / 1.0)) : (_ale_arg12 + (_ale_arg11 / 1.0)))) * cos(_ale_arg9))), ((((_ale_arg13 + 1.5) + _ale_arg7) + (_ale_arg8 * sin(_ale_arg9))) + ((_ale_arg7 * ((_ale_arg10 == 1) ? (1.0 + (_ale_arg11 / 1.0)) : (_ale_arg12 + (_ale_arg11 / 1.0)))) * sin(_ale_arg9))), 0.0, ((((_ale_arg6 + 1.5) + _ale_arg7) + (_ale_arg8 * cos(_ale_arg9))) + ((_ale_arg7 * ((_ale_arg14 == 1) ? (_ale_arg11 / 1.0) : _ale_arg12)) * cos(_ale_arg9))), ((((_ale_arg13 + 1.5) + _ale_arg7) + (_ale_arg8 * sin(_ale_arg9))) + ((_ale_arg7 * ((_ale_arg14 == 1) ? (_ale_arg11 / 1.0) : _ale_arg12)) * sin(_ale_arg9))), 0.0, 0.1, rgb(255, 255, 255))) + _ale_arg15); }
spike___selfRenderSize__2 = function  (_ale_arg9, _ale_arg1, _ale_arg6, _ale_arg7, _ale_arg8, _ale_arg2, _ale_arg4, _ale_arg0, _ale_arg3, _ale_arg5) { return ((((_ale_arg0 != 1) || (_ale_arg1 != 1))) ? 0 : Line3D_size(((((_ale_arg2 + 1.5) + _ale_arg3) + (_ale_arg4 * cos(_ale_arg5))) + ((_ale_arg3 * (1.0 + (_ale_arg6 / 1.0))) * cos(_ale_arg5))), ((((_ale_arg7 + 1.5) + _ale_arg3) + (_ale_arg4 * sin(_ale_arg5))) + ((_ale_arg3 * (1.0 + (_ale_arg6 / 1.0))) * sin(_ale_arg5))), (_ale_arg8 * _ale_arg9), ((((_ale_arg2 + 1.5) + _ale_arg3) + (_ale_arg4 * cos(_ale_arg5))) + ((_ale_arg3 * (1.0 + (_ale_arg6 / 1.0))) * cos(_ale_arg5))), ((((_ale_arg7 + 1.5) + _ale_arg3) + (_ale_arg4 * sin(_ale_arg5))) + ((_ale_arg3 * (1.0 + (_ale_arg6 / 1.0))) * sin(_ale_arg5))), 0.0, 0.1, rgba(255, 255, 255, 204))); }
spike___draw__ = function  (_ale_arg0) { return _ale_arg0; }
spike___renderSize__ = function  (_ale_arg0) { return _ale_arg0; }
spike___selfRenderSize__0 = function  (_ale_arg5, _ale_arg10, _ale_arg6, _ale_arg8, _ale_arg7, _ale_arg0, _ale_arg11, _ale_arg4, _ale_arg9, _ale_arg1, _ale_arg3, _ale_arg12, _ale_arg2) { return ((_ale_arg0 != 1) ? 0 : Line3D_size(((((_ale_arg1 + 1.5) + _ale_arg2) + (_ale_arg3 * cos(_ale_arg4))) + ((_ale_arg2 * ((_ale_arg5 == 1) ? (1.0 + (_ale_arg6 / 1.0)) : (_ale_arg7 + (_ale_arg6 / 1.0)))) * cos(_ale_arg4))), ((((_ale_arg8 + 1.5) + _ale_arg2) + (_ale_arg3 * sin(_ale_arg4))) + ((_ale_arg2 * ((_ale_arg5 == 1) ? (1.0 + (_ale_arg6 / 1.0)) : (_ale_arg7 + (_ale_arg6 / 1.0)))) * sin(_ale_arg4))), (_ale_arg9 * _ale_arg10), ((((_ale_arg1 + 1.5) + _ale_arg2) + (_ale_arg3 * cos(_ale_arg4))) + ((_ale_arg2 * ((_ale_arg11 == 1) ? (_ale_arg6 / 1.0) : _ale_arg7)) * cos(_ale_arg4))), ((((_ale_arg8 + 1.5) + _ale_arg2) + (_ale_arg3 * sin(_ale_arg4))) + ((_ale_arg2 * ((_ale_arg11 == 1) ? (_ale_arg6 / 1.0) : _ale_arg7)) * sin(_ale_arg4))), (_ale_arg9 * _ale_arg12), 0.15, rgba(0, 204, 255, 204))); }
spike___selfRenderSize__1 = function  (_ale_arg6, _ale_arg7, _ale_arg9, _ale_arg8, _ale_arg2, _ale_arg4, _ale_arg1, _ale_arg0, _ale_arg3, _ale_arg10, _ale_arg5) { return ((((_ale_arg0 != 1) || (_ale_arg1 != 1))) ? 0 : Line3D_size(((((_ale_arg2 + 1.5) + _ale_arg3) + (_ale_arg4 * cos(_ale_arg5))) + ((_ale_arg3 * ((_ale_arg6 == 1) ? (1.0 + (_ale_arg7 / 1.0)) : (_ale_arg8 + (_ale_arg7 / 1.0)))) * cos(_ale_arg5))), ((((_ale_arg9 + 1.5) + _ale_arg3) + (_ale_arg4 * sin(_ale_arg5))) + ((_ale_arg3 * ((_ale_arg6 == 1) ? (1.0 + (_ale_arg7 / 1.0)) : (_ale_arg8 + (_ale_arg7 / 1.0)))) * sin(_ale_arg5))), 0.0, ((((_ale_arg2 + 1.5) + _ale_arg3) + (_ale_arg4 * cos(_ale_arg5))) + ((_ale_arg3 * ((_ale_arg10 == 1) ? (_ale_arg7 / 1.0) : _ale_arg8)) * cos(_ale_arg5))), ((((_ale_arg9 + 1.5) + _ale_arg3) + (_ale_arg4 * sin(_ale_arg5))) + ((_ale_arg3 * ((_ale_arg10 == 1) ? (_ale_arg7 / 1.0) : _ale_arg8)) * sin(_ale_arg5))), 0.0, 0.1, rgb(255, 255, 255))); }
spike_enableShadow = function  () { return 0; }
spike_isOn = function  (_ale_arg0) { return ((_ale_arg0 >= 0.0) ? 1 : 0); }
spike___selfRenderSize__ = function  (_ale_arg3, _ale_arg2, _ale_arg1, _ale_arg0) { return (((_ale_arg0 + _ale_arg1) + _ale_arg2) + _ale_arg3); }
spike___draw__0 = function  (_ale_arg13, _ale_arg8, _ale_arg9, _ale_arg11, _ale_arg10, _ale_arg3, _ale_arg0, _ale_arg14, _ale_arg16, _ale_arg7, _ale_arg12, _ale_arg4, _ale_arg6, _ale_arg15,  _ale_arg1, _ale_arg2, _ale_arg5) { return (((_ale_arg0 != 1) ? 0 : Line3D_draw(_ale_arg1, _ale_arg2, _ale_arg3, ((((_ale_arg4 + 1.5) + _ale_arg5) + (_ale_arg6 * cos(_ale_arg7))) + ((_ale_arg5 * ((_ale_arg8 == 1) ? (1.0 + (_ale_arg9 / 1.0)) : (_ale_arg10 + (_ale_arg9 / 1.0)))) * cos(_ale_arg7))), ((((_ale_arg11 + 1.5) + _ale_arg5) + (_ale_arg6 * sin(_ale_arg7))) + ((_ale_arg5 * ((_ale_arg8 == 1) ? (1.0 + (_ale_arg9 / 1.0)) : (_ale_arg10 + (_ale_arg9 / 1.0)))) * sin(_ale_arg7))), (_ale_arg12 * _ale_arg13), ((((_ale_arg4 + 1.5) + _ale_arg5) + (_ale_arg6 * cos(_ale_arg7))) + ((_ale_arg5 * ((_ale_arg14 == 1) ? (_ale_arg9 / 1.0) : _ale_arg10)) * cos(_ale_arg7))), ((((_ale_arg11 + 1.5) + _ale_arg5) + (_ale_arg6 * sin(_ale_arg7))) + ((_ale_arg5 * ((_ale_arg14 == 1) ? (_ale_arg9 / 1.0) : _ale_arg10)) * sin(_ale_arg7))), (_ale_arg12 * _ale_arg15), 0.15, rgba(0, 204, 255, 204))) + _ale_arg16); }
spike___draw__2 = function  (_ale_arg14, _ale_arg1, _ale_arg11, _ale_arg12, _ale_arg6, _ale_arg3, _ale_arg4, _ale_arg15, _ale_arg0, _ale_arg10, _ale_arg13, _ale_arg7, _ale_arg9,  _ale_arg2, _ale_arg5, _ale_arg8) { return (((((_ale_arg0 != 1) || (_ale_arg1 != 1))) ? 0 : Line3D_draw(_ale_arg2, (_ale_arg3 + (_ale_arg4 + _ale_arg5)), _ale_arg6, ((((_ale_arg7 + 1.5) + _ale_arg8) + (_ale_arg9 * cos(_ale_arg10))) + ((_ale_arg8 * (1.0 + (_ale_arg11 / 1.0))) * cos(_ale_arg10))), ((((_ale_arg12 + 1.5) + _ale_arg8) + (_ale_arg9 * sin(_ale_arg10))) + ((_ale_arg8 * (1.0 + (_ale_arg11 / 1.0))) * sin(_ale_arg10))), (_ale_arg13 * _ale_arg14), ((((_ale_arg7 + 1.5) + _ale_arg8) + (_ale_arg9 * cos(_ale_arg10))) + ((_ale_arg8 * (1.0 + (_ale_arg11 / 1.0))) * cos(_ale_arg10))), ((((_ale_arg12 + 1.5) + _ale_arg8) + (_ale_arg9 * sin(_ale_arg10))) + ((_ale_arg8 * (1.0 + (_ale_arg11 / 1.0))) * sin(_ale_arg10))), 0.0, 0.1, rgba(255, 255, 255, 204))) + _ale_arg15); }
generator___renderOffset__ = function  (_ale_arg0, _ale_arg1) { return (_ale_arg0 - _ale_arg1); }
generator___selfRenderSize__ = function  () { return 0; }
generator_increment = function  (_ale_arg0, _ale_arg2, _ale_arg1) { return (1.0 / ((_ale_arg0 - _ale_arg1) * _ale_arg2)); }
generator_childs_depth = function  (_ale_arg0) { return (_ale_arg0 + 1); }
generator___renderSize__ = function  (_ale_arg0, _ale_arg1) { return (_ale_arg0 + _ale_arg1); }
generator___draw__ = function  () { return 0; }
generator_childs_tweenMax = function  (_ale_arg0) { return _ale_arg0; }
generator_childs_increment = function  (_ale_arg0) { return _ale_arg0; }
generator_childs_radius = function  (_ale_arg0) { return _ale_arg0; }
generator_childs___doRenderingLast__ = function  (_ale_arg0) { return _ale_arg0; }
generator_angle = function  (_ale_arg1, _ale_arg0, _ale_arg2) { return ((2 * PI()) * ((_ale_arg0 / 360.0) + ((_ale_arg1 + 0.0) / _ale_arg2))); }
generator_childs_angle = function  (_ale_arg0) { return (0.01 + _ale_arg0); }
generator_childs_height = function  (_ale_arg0) { return _ale_arg0; }
generator_childs_tweenMin = function  (_ale_arg0) { return _ale_arg0; }
generator_childs_xOffset = function  (_ale_arg0) { return _ale_arg0; }
generator_childs_isLast = function  (_ale_arg1, _ale_arg2, _ale_arg0) { return ((((_ale_arg0 <= (_ale_arg1 * _ale_arg2)) && ((_ale_arg0 + 1) > (_ale_arg1 * _ale_arg2)))) ? 1 : 0); }
generator_childs_yOffset = function  (_ale_arg0) { return _ale_arg0; }
generator_childs_isFirst = function  (_ale_arg2, _ale_arg0, _ale_arg1) { return ((((_ale_arg0 >= (_ale_arg1 * _ale_arg2)) && ((_ale_arg0 - 1) < (_ale_arg1 * _ale_arg2)))) ? 1 : 0); }
generator_numSpikes = function  (_ale_arg0) { return _ale_arg0; }
generator_childs_tween = function  (_ale_arg3, _ale_arg5, _ale_arg2, _ale_arg0, _ale_arg1, _ale_arg4) { return ((((_ale_arg0 < (_ale_arg1 * _ale_arg2)) || (_ale_arg0 > (_ale_arg3 * _ale_arg2)))) ? ((- 1.0)) : ((_ale_arg4 - (_ale_arg1 * _ale_arg5)) / ((_ale_arg3 * _ale_arg2) - (_ale_arg1 * _ale_arg2)))); }
generator_childs_minRadius = function  (_ale_arg0) { return _ale_arg0; }
generator_childs_rotation = function  (_ale_arg0) { return _ale_arg0; }
second___selfRenderSize__ = function  (_ale_arg0) { return _ale_arg0; }
second_childs_x = function  (_ale_arg0) { return (_ale_arg0 - 10); }
second_childs_tweenMin = function  (_ale_arg0) { return _ale_arg0; }
second___draw__0 = function  (_ale_arg5, _ale_arg3, _ale_arg2, _ale_arg1,  _ale_arg0, _ale_arg4, _ale_arg6) { return (RectangleZ_draw(_ale_arg0, _ale_arg1, _ale_arg2, (_ale_arg3 - _ale_arg4), (_ale_arg5 - _ale_arg4), (4 * _ale_arg4), (4 * _ale_arg4), ((- 0.1)), rgb(0, 0, 0)) + _ale_arg6); }
second___renderOffset__ = function  (_ale_arg0, _ale_arg1) { return (_ale_arg0 - _ale_arg1); }
second_childs_rotation = function  (_ale_arg0) { return _ale_arg0; }
second_childs_tweenMax = function  (_ale_arg0) { return _ale_arg0; }
second_childs_levelLength = function  (_ale_arg0) { return _ale_arg0; }
second_childs_yOffset = function  (_ale_arg0) { return _ale_arg0; }
second___draw__ = function  (_ale_arg0) { return _ale_arg0; }
second___renderSize__ = function  (_ale_arg0, _ale_arg1) { return (_ale_arg0 + _ale_arg1); }
second_childs_minRadius = function  (_ale_arg0) { return _ale_arg0; }
second___selfRenderSize__0 = function  (_ale_arg2, _ale_arg0, _ale_arg1) { return RectangleZ_size((_ale_arg0 - _ale_arg1), (_ale_arg2 - _ale_arg1), (4 * _ale_arg1), (4 * _ale_arg1), ((- 0.1)), rgb(0, 0, 0)); }
second_w = function  () { return 10; }
second_childs_xOffset = function  (_ale_arg0) { return _ale_arg0; }
second_childs_height = function  (_ale_arg0) { return _ale_arg0; }
second_childs___doRenderingLast__ = function  (_ale_arg0) { return _ale_arg0; }
second_childs_depth = function  (_ale_arg0) { return (_ale_arg0 + 1); }
second_childs_radius = function  (_ale_arg0) { return _ale_arg0; }
// Generated code. Modifcation to this file will be lost on next code generation.
/**
 * @file traversals.cl
...
this.visit_root_0 = function (index, tree_size,  int_buffer_1,  float_buffer_1,  grammartokens_buffer_1,  nodeindex_buffer_1) {
  ...
  this.fld_secondi_height[this.GetAbsoluteIndex(this.fld_root_child_child_leftmost_child[index], index)] = root_child_height(this.fld_iroot_height[index]);
  this.fld_secondi_minradius[this.GetAbsoluteIndex(this.fld_root_child_child_leftmost_child[index], index)] = root_child_minRadius(this.fld_iroot_minradius[index]);
  this.fld_secondi_radius[this.GetAbsoluteIndex(this.fld_root_child_child_leftmost_child[index], index)] = root_child_radius(this.fld_iroot_radius[index]);
  this.fld_secondi_rotation[this.GetAbsoluteIndex(this.fld_root_child_child_leftmost_child[index], index)] = root_child_rotation(this.fld_iroot_rotation[index]);
  this.fld_secondi_tweenmax[this.GetAbsoluteIndex(this.fld_root_child_child_leftmost_child[index], index)] = root_child_tweenMax(this.fld_iroot_tweenmax[index]);
  this.fld_secondi_tweenmin[this.GetAbsoluteIndex(this.fld_root_child_child_leftmost_child[index], index)] = root_child_tweenMin(this.fld_iroot_tweenmin[index]);
  this.fld_secondi_xoffset[this.GetAbsoluteIndex(this.fld_root_child_child_leftmost_child[index], index)] = root_child_xOffset(this.fld_iroot_xoffset[index]);
  this.fld_secondi_yoffset[this.GetAbsoluteIndex(this.fld_root_child_child_leftmost_child[index], index)] = root_child_yOffset(this.fld_iroot_yoffset[index]);
  this.fld_iroot_depth[index] = root_depth();
  this.fld_root___draw__[index] = root___draw__();
  this.fld_root___selfrendersize__[index] = root___selfRenderSize__();
  this.fld_secondi_depth[this.GetAbsoluteIndex(this.fld_root_child_child_leftmost_child[index], index)] = root_child_depth(this.fld_iroot_depth[index]);
  this.fld_secondi___dorenderinglast__[this.GetAbsoluteIndex(this.fld_root_child_child_leftmost_child[index], index)] = root_child___doRenderingLast__(this.fld_root___draw__[index]);
}
this.visit_generator_0 = function (index, tree_size,  int_buffer_1,  float_buffer_1,  grammartokens_buffer_1,  nodeindex_buffer_1) {
	
	// Variables needed for loop macro. Declare up top to avoid declaring a
	// multitide below, one for every loop
	var step = 0;
 	var prev_child_idx = 0;
  this.fld_generator_angle[index] = generator_angle(this.fld_node_idx[index], this.fld_node_rotation[index], this.fld_node_levellength[index]);
  this.fld_generator___draw__[index] = generator___draw__();
  this.fld_generator___selfrendersize__[index] = generator___selfRenderSize__();
  this.fld_generator_childs_idx_init[index] = (0);
  this.fld_generator_childs_idx_last[index] = this.fld_generator_childs_idx_init[index];
    step = 0; prev_child_idx = 0; for (var current_node = this.GetAbsoluteIndex(this.fld_generator_child_childs_leftmost_child[index], index); current_node != 0; current_node = this.GetAbsoluteIndex(this.right_siblings[current_node], current_node)) {step++; 
      this.fld_leaf_depth[current_node] = ((this.fld_node_depth[index] + 1));
      this.fld_leaf_height[current_node] = (this.fld_node_height[index] );
      this.fld_leaf_idx[current_node] = (((step == 1 ? (this.fld_generator_childs_idx_last[index]) : (this.fld_leaf_idx[prev_child_idx])) + 1));
      this.fld_leaf_minradius[current_node] = (this.fld_node_minradius[index] );
      this.fld_leaf_radius[current_node] = (this.fld_node_radius[index] );
      this.fld_leaf_rotation[current_node] = (this.fld_node_rotation[index] );
      this.fld_leaf_tweenmax[current_node] = (this.fld_node_tweenmax[index] );
      this.fld_leaf_tweenmin[current_node] = (this.fld_node_tweenmin[index] );
      this.fld_leaf_xoffset[current_node] = (this.fld_node_xoffset[index] );
      this.fld_leaf_yoffset[current_node] = (this.fld_node_yoffset[index] );
      this.fld_leaf_angle[current_node] = ((0.01 + this.fld_generator_angle[index]));
	if (!this.GetAbsoluteIndex(this.right_siblings[current_node], current_node)) {
        this.fld_generator_childs_idx_last[index] = this.fld_leaf_idx[current_node];
		break;
	}
   prev_child_idx = current_node; }
  this.fld_generator_childs_valcopy_init[index] = (0);
  this.fld_generator_childs_valcopy_last[index] = this.fld_generator_childs_valcopy_init[index];
    this.fld_generator_childs_valprev_init[index] = (0);
  this.fld_generator_childs_valprev_last[index] = this.fld_generator_childs_valprev_init[index];
    step = 0; prev_child_idx = 0; for (var current_node = this.GetAbsoluteIndex(this.fld_generator_child_childs_leftmost_child[index], index); current_node != 0; current_node = this.GetAbsoluteIndex(this.right_siblings[current_node], current_node)) {step++; 
      this.fld_leaf___dorenderinglast__[current_node] = (this.fld_generator___draw__[index] );
      this.fld_leaf_valcopy[current_node] = (this.fld_leaf_val[current_node] );
      this.fld_leaf_valprev[current_node] = ((step == 1 ? (this.fld_generator_childs_valcopy_last[index]) : (this.fld_leaf_valcopy[prev_child_idx])) );
   prev_child_idx = current_node; }
  this.fld_generator_numspikes[index] = generator_numSpikes(this.fld_generator_childs_idx_last[index]);
  this.fld_generator_increment[index] = generator_increment(this.fld_node_tweenmax[index], this.fld_generator_numspikes[index], this.fld_node_tweenmin[index]);
  step = 0; prev_child_idx = 0; for (var current_node = this.GetAbsoluteIndex(this.fld_generator_child_childs_leftmost_child[index], index); current_node != 0; current_node = this.GetAbsoluteIndex(this.right_siblings[current_node], current_node)) {step++; 
      this.fld_leaf_isfirst[current_node] = (((((this.fld_leaf_idx[current_node] >= (this.fld_node_tweenmin[index] * this.fld_generator_numspikes[index])) && ((this.fld_leaf_idx[current_node] - 1) < (this.fld_node_tweenmin[index] * this.fld_generator_numspikes[index])))) ? 1 : 0));
      this.fld_leaf_islast[current_node] = (((((this.fld_leaf_idx[current_node] <= (this.fld_node_tweenmax[index] * this.fld_generator_numspikes[index])) && ((this.fld_leaf_idx[current_node] + 1) > (this.fld_node_tweenmax[index] * this.fld_generator_numspikes[index])))) ? 1 : 0));
      this.fld_leaf_tween[current_node] = (((((this.fld_leaf_idx[current_node] < (this.fld_node_tweenmin[index] * this.fld_generator_numspikes[index])) || (this.fld_leaf_idx[current_node] > (this.fld_node_tweenmax[index] * this.fld_generator_numspikes[index])))) ? ((- 1.0)) : ((this.fld_leaf_idx[current_node] - (this.fld_node_tweenmin[index] * this.fld_generator_childs_idx_last[index])) / ((this.fld_node_tweenmax[index] * this.fld_generator_numspikes[index]) - (this.fld_node_tweenmin[index] * this.fld_generator_numspikes[index])))));
      this.fld_leaf_increment[current_node] = (this.fld_generator_increment[index] );
   prev_child_idx = current_node; }
}
this.visit_spike_0 = function (index, tree_size,  int_buffer_1,  float_buffer_1,  grammartokens_buffer_1,  nodeindex_buffer_1) {
	
	// Variables needed for loop macro. Declare up top to avoid declaring a
	// multitide below, one for every loop
	var step = 0;
 	var prev_child_idx = 0;
  this.fld_spike_enableshadow[index] = spike_enableShadow();
  this.fld_spike_ison[index] = spike_isOn(this.fld_leaf_tween[index]);
  this.fld_spike___selfrendersize__0[index] = spike___selfRenderSize__0(this.fld_leaf_islast[index], this.fld_leaf_val[index], this.fld_leaf_increment[index], this.fld_leaf_yoffset[index], this.fld_leaf_tween[index], this.fld_spike_ison[index], this.fld_leaf_isfirst[index], this.fld_leaf_angle[index], this.fld_leaf_height[index], this.fld_leaf_xoffset[index], this.fld_leaf_minradius[index], this.fld_leaf_valprev[index], this.fld_leaf_radius[index]);
  this.fld_spike___selfrendersize__1[index] = spike___selfRenderSize__1(this.fld_leaf_islast[index], this.fld_leaf_increment[index], this.fld_leaf_yoffset[index], this.fld_leaf_tween[index], this.fld_leaf_xoffset[index], this.fld_leaf_minradius[index], this.fld_spike_enableshadow[index], this.fld_spike_ison[index], this.fld_leaf_radius[index], this.fld_leaf_isfirst[index], this.fld_leaf_angle[index]);
  this.fld_spike___selfrendersize__2[index] = spike___selfRenderSize__2(this.fld_leaf_val[index], this.fld_leaf_islast[index], this.fld_leaf_increment[index], this.fld_leaf_yoffset[index], this.fld_leaf_height[index], this.fld_leaf_xoffset[index], this.fld_leaf_minradius[index], this.fld_spike_ison[index], this.fld_leaf_radius[index], this.fld_leaf_angle[index]);
  this.fld_spike___selfrendersize__3[index] = spike___selfRenderSize__3(this.fld_leaf_increment[index], this.fld_leaf_yoffset[index], this.fld_leaf_height[index], this.fld_leaf_xoffset[index], this.fld_leaf_minradius[index], this.fld_leaf_valprev[index], this.fld_spike_ison[index], this.fld_leaf_radius[index], this.fld_leaf_isfirst[index], this.fld_leaf_angle[index]);
  this.fld_spike___selfrendersize__[index] = spike___selfRenderSize__(this.fld_spike___selfrendersize__3[index], this.fld_spike___selfrendersize__2[index], this.fld_spike___selfrendersize__1[index], this.fld_spike___selfrendersize__0[index]);
  this.fld_leaf___rendersize__[index] = spike___renderSize__(this.fld_spike___selfrendersize__[index]);
}
this.visit_second_0 = function (index, tree_size,  int_buffer_1,  float_buffer_1,  grammartokens_buffer_1,  nodeindex_buffer_1) {
	
	// Variables needed for loop macro. Declare up top to avoid declaring a
	// multitide below, one for every loop
	var step = 0;
 	var prev_child_idx = 0;
  this.fld_second___selfrendersize__0[index] = second___selfRenderSize__0(this.fld_secondi_yoffset[index], this.fld_secondi_xoffset[index], this.fld_secondi_radius[index]);
  this.fld_secondi_w[index] = second_w();
  this.fld_second___selfrendersize__[index] = second___selfRenderSize__(this.fld_second___selfrendersize__0[index]);
  this.fld_second_childs_idx_init[index] = (0);
  this.fld_second_childs_idx_last[index] = this.fld_second_childs_idx_init[index];
    this.fld_second_len_init[index] = (0);
  this.fld_second_len[index] = this.fld_second_len_init[index];
    step = 0; prev_child_idx = 0; for (var current_node = this.GetAbsoluteIndex(this.fld_second_child_childs_leftmost_child[index], index); current_node != 0; current_node = this.GetAbsoluteIndex(this.right_siblings[current_node], current_node)) {step++; 
      this.fld_node_depth[current_node] = ((this.fld_secondi_depth[index] + 1));
      this.fld_node_height[current_node] = (this.fld_secondi_height[index] );
      this.fld_node_idx[current_node] = (((step == 1 ? (this.fld_second_childs_idx_last[index]) : (this.fld_node_idx[prev_child_idx])) + 1));
      this.fld_node_minradius[current_node] = (this.fld_secondi_minradius[index] );
      this.fld_node_radius[current_node] = (this.fld_secondi_radius[index] );
      this.fld_node_rotation[current_node] = (this.fld_secondi_rotation[index] );
      this.fld_node_tweenmax[current_node] = (this.fld_secondi_tweenmax[index] );
      this.fld_node_tweenmin[current_node] = (this.fld_secondi_tweenmin[index] );
      this.fld_node_xoffset[current_node] = (this.fld_secondi_xoffset[index] );
      this.fld_node_yoffset[current_node] = (this.fld_secondi_yoffset[index] );
      this.fld_second_len[index] = ((this.fld_second_len[index] + 1));
   prev_child_idx = current_node; }
  step = 0; prev_child_idx = 0; for (var current_node = this.GetAbsoluteIndex(this.fld_second_child_childs_leftmost_child[index], index); current_node != 0; current_node = this.GetAbsoluteIndex(this.right_siblings[current_node], current_node)) {step++; 
      this.fld_node_levellength[current_node] = (this.fld_second_len[index] );
   prev_child_idx = current_node; }
}
///// pass /////
this.visit_root_1 = function (index, tree_size,  int_buffer_1,  float_buffer_1,  grammartokens_buffer_1,  nodeindex_buffer_1) {
	...
	var step = 0;
 	var prev_child_idx = 0;
  this.fld_secondi_rx[this.GetAbsoluteIndex(this.fld_root_child_child_leftmost_child[index], index)] = root_child_rx(this.fld_secondi_w[this.GetAbsoluteIndex(this.fld_root_child_child_leftmost_child[index], index)]);
  this.fld_root___childrendersize__[index] = root___childRenderSize__(this.fld_secondi___rendersize__[this.GetAbsoluteIndex(this.fld_root_child_child_leftmost_child[index], index)]);
  this.fld_secondi_x[this.GetAbsoluteIndex(this.fld_root_child_child_leftmost_child[index], index)] = root_child_x(this.fld_secondi_w[this.GetAbsoluteIndex(this.fld_root_child_child_leftmost_child[index], index)], this.fld_secondi_rx[this.GetAbsoluteIndex(this.fld_root_child_child_leftmost_child[index], index)]);
  ...
  this.fld_secondi___renderrightoffset__[this.GetAbsoluteIndex(this.fld_root_child_child_leftmost_child[index], index)] = root_child___renderRightOffset__(this.fld_secondi___rendersize__[this.GetAbsoluteIndex(this.fld_root_child_child_leftmost_child[index], index)], this.fld_root___selfrendersize__[index], this.fld_iroot___renderoffset__[index]);
}
this.visit_generator_1 = function (index, tree_size,  int_buffer_1,  float_buffer_1,  grammartokens_buffer_1,  nodeindex_buffer_1) {
  ...
  step = 0; prev_child_idx = 0; for (var current_node = this.GetAbsoluteIndex(this.fld_generator_child_childs_leftmost_child[index], index); current_node != 0; current_node = this.GetAbsoluteIndex(this.right_siblings[current_node], current_node)) {step++; 
   prev_child_idx = current_node; }
  this.fld_generator___childsrendersize___init[index] = (0);
  this.fld_generator___childsrendersize__[index] = this.fld_generator___childsrendersize___init[index];
    step = 0; prev_child_idx = 0; for (var current_node = this.GetAbsoluteIndex(this.fld_generator_child_childs_leftmost_child[index], index); current_node != 0; current_node = this.GetAbsoluteIndex(this.right_siblings[current_node], current_node)) {step++; 
      this.fld_generator___childsrendersize__[index] = ((this.fld_generator___childsrendersize__[index] + this.fld_leaf___rendersize__[current_node]));
   prev_child_idx = current_node; }
  this.fld_node___rendersize__[index] = generator___renderSize__(this.fld_generator___childsrendersize__[index], this.fld_generator___selfrendersize__[index]);
}
this.visit_spike_1 = function (index, tree_size,  int_buffer_1,  float_buffer_1,  grammartokens_buffer_1,  nodeindex_buffer_1) {
...
this.visit_second_1 = function (index, tree_size,  int_buffer_1,  float_buffer_1,  grammartokens_buffer_1,  nodeindex_buffer_1) {
  ...
  step = 0; prev_child_idx = 0; for (var current_node = this.GetAbsoluteIndex(this.fld_second_child_childs_leftmost_child[index], index); current_node != 0; current_node = this.GetAbsoluteIndex(this.right_siblings[current_node], current_node)) {step++; 
   prev_child_idx = current_node; }
  this.fld_second___childsrendersize___init[index] = (0);
  this.fld_second___childsrendersize__[index] = this.fld_second___childsrendersize___init[index];
    step = 0; prev_child_idx = 0; for (var current_node = this.GetAbsoluteIndex(this.fld_second_child_childs_leftmost_child[index], index); current_node != 0; current_node = this.GetAbsoluteIndex(this.right_siblings[current_node], current_node)) {step++; 
      this.fld_second___childsrendersize__[index] = ((this.fld_second___childsrendersize__[index] + this.fld_node___rendersize__[current_node]));
   prev_child_idx = current_node; }
  this.fld_secondi___rendersize__[index] = second___renderSize__(this.fld_second___childsrendersize__[index], this.fld_second___selfrendersize__[index]);
}
///// pass /////
this.visit_root_2 = function (index, tree_size,  int_buffer_1,  float_buffer_1,  grammartokens_buffer_1,  nodeindex_buffer_1,  glBuffer) {
...
this.visit_generator_2 = function (index, tree_size,  int_buffer_1,  float_buffer_1,  grammartokens_buffer_1,  nodeindex_buffer_1,  glBuffer) {
	
	// Variables needed for loop macro. Declare up top to avoid declaring a
	// multitide below, one for every loop
	var step = 0;
 	var prev_child_idx = 0;
  this.fld_node___renderoffset__[index] = generator___renderOffset__(this.fld_node___renderrightoffset__[index], this.fld_node___rendersize__[index]);
  this.fld_generator_childs___renderrightoffset___init[index] = ((this.fld_node___renderoffset__[index] + this.fld_generator___selfrendersize__[index]));
  this.fld_generator_childs___renderrightoffset___last[index] = this.fld_generator_childs___renderrightoffset___init[index];
    step = 0; prev_child_idx = 0; for (var current_node = this.GetAbsoluteIndex(this.fld_generator_child_childs_leftmost_child[index], index); current_node != 0; current_node = this.GetAbsoluteIndex(this.right_siblings[current_node], current_node)) {step++; 
      this.fld_leaf___renderrightoffset__[current_node] = (((step == 1 ? (this.fld_generator_childs___renderrightoffset___last[index]) : (this.fld_leaf___renderrightoffset__[prev_child_idx])) + this.fld_leaf___rendersize__[current_node]));
   prev_child_idx = current_node; }
}
this.visit_spike_2 = function (index, tree_size,  int_buffer_1,  float_buffer_1,  grammartokens_buffer_1,  nodeindex_buffer_1,  glBuffer) {
	
	// Variables needed for loop macro. Declare up top to avoid declaring a
	// multitide below, one for every loop
	var step = 0;
 	var prev_child_idx = 0;
  this.fld_leaf___renderoffset__[index] = spike___renderOffset__(this.fld_leaf___renderrightoffset__[index], this.fld_leaf___rendersize__[index]);
  this.fld_spike___draw__0[index] = spike___draw__0(this.fld_leaf_val[index], this.fld_leaf_islast[index], this.fld_leaf_increment[index], this.fld_leaf_yoffset[index], this.fld_leaf_tween[index], this.fld_spike___selfrendersize__0[index], this.fld_spike_ison[index], this.fld_leaf_isfirst[index], this.fld_leaf___dorenderinglast__[index], this.fld_leaf_angle[index], this.fld_leaf_height[index], this.fld_leaf_xoffset[index], this.fld_leaf_minradius[index], this.fld_leaf_valprev[index], glBuffer, this.fld_leaf___renderoffset__[index], this.fld_leaf_radius[index]);
  this.fld_spike___draw__1[index] = spike___draw__1(this.fld_leaf_islast[index], this.fld_leaf_increment[index], this.fld_leaf_yoffset[index], this.fld_leaf_tween[index], this.fld_spike___selfrendersize__1[index], this.fld_spike___draw__0[index], this.fld_spike___selfrendersize__0[index], this.fld_spike_ison[index], this.fld_spike_enableshadow[index], this.fld_leaf_isfirst[index], this.fld_leaf_angle[index], this.fld_leaf_xoffset[index], this.fld_leaf_minradius[index], glBuffer, this.fld_leaf___renderoffset__[index], this.fld_leaf_radius[index]);
  this.fld_spike___draw__2[index] = spike___draw__2(this.fld_leaf_val[index], this.fld_leaf_islast[index], this.fld_leaf_increment[index], this.fld_leaf_yoffset[index], this.fld_spike___selfrendersize__2[index], this.fld_spike___selfrendersize__1[index], this.fld_spike___selfrendersize__0[index], this.fld_spike___draw__1[index], this.fld_spike_ison[index], this.fld_leaf_angle[index], this.fld_leaf_height[index], this.fld_leaf_xoffset[index], this.fld_leaf_minradius[index], glBuffer, this.fld_leaf___renderoffset__[index], this.fld_leaf_radius[index]);
  this.fld_spike___draw__3[index] = spike___draw__3(this.fld_leaf_increment[index], this.fld_leaf_yoffset[index], this.fld_spike___selfrendersize__3[index], this.fld_spike___draw__2[index], this.fld_spike___selfrendersize__2[index], this.fld_spike___selfrendersize__1[index], this.fld_spike___selfrendersize__0[index], this.fld_spike_ison[index], this.fld_leaf_isfirst[index], this.fld_leaf_angle[index], this.fld_leaf_height[index], this.fld_leaf_xoffset[index], this.fld_leaf_minradius[index], this.fld_leaf_valprev[index], glBuffer, this.fld_leaf___renderoffset__[index], this.fld_leaf_radius[index]);
  this.fld_spike___draw__[index] = spike___draw__(this.fld_spike___draw__3[index]);
}
this.visit_second_2 = function (index, tree_size,  int_buffer_1,  float_buffer_1,  grammartokens_buffer_1,  nodeindex_buffer_1,  glBuffer) {
	
	// Variables needed for loop macro. Declare up top to avoid declaring a
	// multitide below, one for every loop
	var step = 0;
 	var prev_child_idx = 0;
  this.fld_secondi___renderoffset__[index] = second___renderOffset__(this.fld_secondi___renderrightoffset__[index], this.fld_secondi___rendersize__[index]);
  this.fld_second___draw__0[index] = second___draw__0(this.fld_secondi_yoffset[index], this.fld_secondi_xoffset[index], this.fld_second___selfrendersize__0[index], this.fld_secondi___renderoffset__[index], glBuffer, this.fld_secondi_radius[index], this.fld_secondi___dorenderinglast__[index]);
  this.fld_second_childs_rx_init[index] = (this.fld_secondi_x[index] );
  this.fld_second_childs_rx_last[index] = this.fld_second_childs_rx_init[index];
    step = 0; prev_child_idx = 0; for (var current_node = this.GetAbsoluteIndex(this.fld_second_child_childs_leftmost_child[index], index); current_node != 0; current_node = this.GetAbsoluteIndex(this.right_siblings[current_node], current_node)) {step++; 
      this.fld_node_rx[current_node] = ((((step == 1 ? (this.fld_second_childs_rx_last[index]) : (this.fld_node_rx[prev_child_idx])) + 5) + 10));
   prev_child_idx = current_node; }
  this.fld_second___draw__[index] = second___draw__(this.fld_second___draw__0[index]);
  this.fld_second_childs___renderrightoffset___init[index] = ((this.fld_secondi___renderoffset__[index] + this.fld_second___selfrendersize__[index]));
  this.fld_second_childs___renderrightoffset___last[index] = this.fld_second_childs___renderrightoffset___init[index];
    step = 0; prev_child_idx = 0; for (var current_node = this.GetAbsoluteIndex(this.fld_second_child_childs_leftmost_child[index], index); current_node != 0; current_node = this.GetAbsoluteIndex(this.right_siblings[current_node], current_node)) {step++; 
      this.fld_node___renderrightoffset__[current_node] = (((step == 1 ? (this.fld_second_childs___renderrightoffset___last[index]) : (this.fld_node___renderrightoffset__[prev_child_idx])) + this.fld_node___rendersize__[current_node]));
      this.fld_node_x[current_node] = ((this.fld_node_rx[current_node] - 10));
   prev_child_idx = current_node; }
  step = 0; prev_child_idx = 0; for (var current_node = this.GetAbsoluteIndex(this.fld_second_child_childs_leftmost_child[index], index); current_node != 0; current_node = this.GetAbsoluteIndex(this.right_siblings[current_node], current_node)) {step++; 
      this.fld_node___dorenderinglast__[current_node] = (this.fld_second___draw__[index] );
   prev_child_idx = current_node; }
}
...
this.visit_0 = function (index, tree_size,  int_buffer_1,  float_buffer_1,  grammartokens_buffer_1,  nodeindex_buffer_1) {
	...
	switch(this.displayname[index]) {
		case this.TOK_ROOT:
			...
			break;
		case this.TOK_SECOND:
			this.visit_second_0(index, tree_size, int_buffer_1, float_buffer_1, grammartokens_buffer_1, nodeindex_buffer_1);
			break;
		case this.TOK_GENERATOR:
			this.visit_generator_0(index, tree_size, int_buffer_1, float_buffer_1, grammartokens_buffer_1, nodeindex_buffer_1);
			break;
		case this.TOK_SPIKE:
			this.visit_spike_0(index, tree_size, int_buffer_1, float_buffer_1, grammartokens_buffer_1, nodeindex_buffer_1);
			break;
	}
}
this.visit_1 = function (index, tree_size,  int_buffer_1,  float_buffer_1,  grammartokens_buffer_1,  nodeindex_buffer_1) {
	...
	switch(this.displayname[index]) {
		case this.TOK_ROOT:
			...
			break;
		case this.TOK_SECOND:
			this.visit_second_1(index, tree_size, int_buffer_1, float_buffer_1, grammartokens_buffer_1, nodeindex_buffer_1);
			break;
		case this.TOK_GENERATOR:
			this.visit_generator_1(index, tree_size, int_buffer_1, float_buffer_1, grammartokens_buffer_1, nodeindex_buffer_1);
			break;
		case this.TOK_SPIKE:
			this.visit_spike_1(index, tree_size, int_buffer_1, float_buffer_1, grammartokens_buffer_1, nodeindex_buffer_1);
			break;
	}
}
this.visit_2 = function (index, tree_size,  int_buffer_1,  float_buffer_1,  grammartokens_buffer_1,  nodeindex_buffer_1,  glBuffer) {
	
	switch(this.displayname[index]) {
		case this.TOK_ROOT:
			this.visit_root_2(index, tree_size, int_buffer_1, float_buffer_1, grammartokens_buffer_1, nodeindex_buffer_1, glBuffer);
			break;
		case this.TOK_SECOND:
			this.visit_second_2(index, tree_size, int_buffer_1, float_buffer_1, grammartokens_buffer_1, nodeindex_buffer_1, glBuffer);
			break;
		case this.TOK_GENERATOR:
			this.visit_generator_2(index, tree_size, int_buffer_1, float_buffer_1, grammartokens_buffer_1, nodeindex_buffer_1, glBuffer);
			break;
		case this.TOK_SPIKE:
			this.visit_spike_2(index, tree_size, int_buffer_1, float_buffer_1, grammartokens_buffer_1, nodeindex_buffer_1, glBuffer);
			break;
	}
}
