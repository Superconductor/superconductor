...
this._gen_allocateHostProxies = function (treeSize) {
	...
	this.fld_hsquare_childs_maxturnout_init = this.float_buffer_1.subarray(treeSize * 111, (treeSize * 111) + treeSize);
	this.fld_hsquare_childs_maxturnout_last = this.float_buffer_1.subarray(treeSize * 112, (treeSize * 112) + treeSize);
	...
	this.fld_hsquare_childs_w_init = this.float_buffer_1.subarray(treeSize * 113, (treeSize * 113) + treeSize);
	this.fld_hsquare_childs_w_last = this.float_buffer_1.subarray(treeSize * 114, (treeSize * 114) + treeSize);
	...
	this.fld_region_childs_maxturnout_init = this.float_buffer_1.subarray(treeSize * 53, (treeSize * 53) + treeSize);
	this.fld_region_childs_maxturnout_last = this.float_buffer_1.subarray(treeSize * 54, (treeSize * 54) + treeSize);
	...
	this.fld_region_childs_w_init = this.float_buffer_1.subarray(treeSize * 51, (treeSize * 51) + treeSize);
	this.fld_region_childs_w_last = this.float_buffer_1.subarray(treeSize * 52, (treeSize * 52) + treeSize);
...
root_childs___renderRightOffset__ = function  (_ale_arg1, _ale_arg0, _ale_arg2) { return ((_ale_arg0 + _ale_arg1) + _ale_arg2); }
...
district___draw__0 = function  (_ale_arg6, _ale_arg3, _ale_arg0, _ale_arg2,  _ale_arg1, _ale_arg8, _ale_arg7, _ale_arg5, _ale_arg4) { return (((_ale_arg0 != 0) ? RectangleOutline_draw(_ale_arg1, _ale_arg2, _ale_arg3, _ale_arg4, _ale_arg5, _ale_arg6, _ale_arg7, 10.0, rgb(0, 0, 0)) : 0) + _ale_arg8); }
...
district___selfRenderSize__0 = function  (_ale_arg3, _ale_arg0, _ale_arg4, _ale_arg2, _ale_arg1) { return ((_ale_arg0 != 0) ? RectangleOutline_size(_ale_arg1, _ale_arg2, _ale_arg3, _ale_arg4, 10.0, rgb(0, 0, 0)) : 0); }
...
pollingplace___draw__0 = function  (_ale_arg8, _ale_arg5, _ale_arg2, _ale_arg1,  _ale_arg0, _ale_arg7, _ale_arg10, _ale_arg6, _ale_arg4, _ale_arg9, _ale_arg3) { return (Rectangle_draw(_ale_arg0, _ale_arg1, _ale_arg2, _ale_arg3, _ale_arg4, _ale_arg5, _ale_arg6, lerpColor(_ale_arg7, _ale_arg8, _ale_arg9)) + _ale_arg10); }
...
pollingplace___selfRenderSize__0 = function  (_ale_arg5, _ale_arg2, _ale_arg4, _ale_arg3, _ale_arg1, _ale_arg6, _ale_arg0) { return Rectangle_size(_ale_arg0, _ale_arg1, _ale_arg2, _ale_arg3, lerpColor(_ale_arg4, _ale_arg5, _ale_arg6)); }
...
countrycontainer___selfRenderSize__0 = function  (_ale_arg3, _ale_arg0, _ale_arg4, _ale_arg2, _ale_arg1) { return ((_ale_arg0 != 0) ? RectangleOutline_size(_ale_arg1, _ale_arg2, _ale_arg3, _ale_arg4, 10.0, rgb(0, 0, 0)) : 0); }
countrycontainer___draw__0 = function  (_ale_arg6, _ale_arg3, _ale_arg0, _ale_arg2,  _ale_arg1, _ale_arg8, _ale_arg7, _ale_arg5, _ale_arg4) { return (((_ale_arg0 != 0) ? RectangleOutline_draw(_ale_arg1, _ale_arg2, _ale_arg3, _ale_arg4, _ale_arg5, _ale_arg6, _ale_arg7, 10.0, rgb(0, 0, 0)) : 0) + _ale_arg8); }
countrycontainer_childs_by = function  () { return 0; }
...
countrycontainer_y = function  () { return 0; }
...
this.visit_countrycontainer_0 = function (index, tree_size,  int_buffer_1,  float_buffer_1,  grammartokens_buffer_1,  nodeindex_buffer_1) {
	...
	var step = 0;
 	var prev_child_idx = 0;
  this.fld_node_y[index] = countrycontainer_y();
  step = 0; prev_child_idx = 0; for (var current_node = this.GetAbsoluteIndex(this.fld_countrycontainer_child_childs_leftmost_child[index], index); current_node != 0; current_node = this.GetAbsoluteIndex(this.right_siblings[current_node], current_node)) {step++; 
      this.fld_node_by[current_node] = (0);
      this.fld_node_fixwidth[current_node] = (this.fld_node_fixwidth[index] );
      this.fld_node_maxturnout[current_node] = (this.fld_node_maxturnout[index] );
      this.fld_node_minturnout[current_node] = (this.fld_node_minturnout[index] );
      this.fld_node_showfraud[current_node] = (this.fld_node_showfraud[index] );
...
this.visit_region_2 = function (index, tree_size,  int_buffer_1,  float_buffer_1,  grammartokens_buffer_1,  nodeindex_buffer_1) {
  ...
  this.fld_region_childs_by_init[index] = (0);
...
this.visit_root_3 = function (index, tree_size,  int_buffer_1,  float_buffer_1,  grammartokens_buffer_1,  nodeindex_buffer_1) {
  ...
  this.fld_node___renderrightoffset__[this.GetAbsoluteIndex(this.fld_root_child_childs_leftmost_child[index], index)] = root_childs___renderRightOffset__(this.fld_root___selfrendersize__[index], this.fld_iroot___renderoffset__[index], this.fld_node___rendersize__[this.GetAbsoluteIndex(this.fld_root_child_childs_leftmost_child[index], index)]);
}
...
this.visit_district_4 = function (index, tree_size,  int_buffer_1,  float_buffer_1,  grammartokens_buffer_1,  nodeindex_buffer_1,  glBuffer) {
  ...
  this.fld_district___draw__0[index] = district___draw__0(this.fld_node_w[index], this.fld_district___selfrendersize__0[index], this.fld_node_fixwidth[index], this.fld_node___renderoffset__[index], glBuffer, this.fld_node___dorenderinglast__[index], this.fld_node_h[index], this.fld_node_y[index], this.fld_node_x[index]);
...
this.visit_countrycontainer_4 = function (index, tree_size,  int_buffer_1,  float_buffer_1,  grammartokens_buffer_1,  nodeindex_buffer_1,  glBuffer) {
  ...
  this.fld_countrycontainer___draw__0[index] = countrycontainer___draw__0(this.fld_node_w[index], this.fld_countrycontainer___selfrendersize__0[index], this.fld_node_fixwidth[index], this.fld_node___renderoffset__[index], glBuffer, this.fld_node___dorenderinglast__[index], this.fld_node_h[index], this.fld_node_y[index], this.fld_node_x[index]);
