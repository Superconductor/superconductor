...
if (!this.cfg.nodeCL && typeof webcl.enableExtension == "function") {
...
this._gen_allocateHostBuffers = function(treeSize) {
	...
	this.DOUBLE_BUFFER_1_SIZE = 1;
	this.double_buffer_1 = new Float64Array(this.DOUBLE_BUFFER_1_SIZE * treeSize);
...
this._gen_allocateHostProxies = function (treeSize) {
	...
	this.fld_hbox_child_childs_count = this.int_buffer_1.subarray(treeSize * 26, (treeSize * 26) + treeSize);
	this.fld_hbox_child_childs_leftmost_child = this.nodeindex_buffer_1.subarray(treeSize * 1, (treeSize * 1) + treeSize);
	this.fld_hbox_childs_depth_init = this.int_buffer_1.subarray(treeSize * 31, (treeSize * 31) + treeSize);
	this.fld_hbox_childs_depth_last = this.int_buffer_1.subarray(treeSize * 32, (treeSize * 32) + treeSize);
	this.fld_hbox_childs_rx_init = this.float_buffer_1.subarray(treeSize * 12, (treeSize * 12) + treeSize);
	this.fld_hbox_childs_rx_last = this.float_buffer_1.subarray(treeSize * 13, (treeSize * 13) + treeSize);
	this.fld_hbox_childs___dorenderinglast___init = this.int_buffer_1.subarray(treeSize * 27, (treeSize * 27) + treeSize);
	this.fld_hbox_childs___dorenderinglast___last = this.int_buffer_1.subarray(treeSize * 28, (treeSize * 28) + treeSize);
	this.fld_hbox_childs___renderrightoffset___init = this.int_buffer_1.subarray(treeSize * 33, (treeSize * 33) + treeSize);
	this.fld_hbox_childs___renderrightoffset___last = this.int_buffer_1.subarray(treeSize * 34, (treeSize * 34) + treeSize);
	this.fld_hbox_childs_x_init = this.float_buffer_1.subarray(treeSize * 10, (treeSize * 10) + treeSize);
	this.fld_hbox_childs_x_last = this.float_buffer_1.subarray(treeSize * 11, (treeSize * 11) + treeSize);
	this.fld_hbox_childs_y_init = this.float_buffer_1.subarray(treeSize * 14, (treeSize * 14) + treeSize);
	this.fld_hbox_childs_y_last = this.float_buffer_1.subarray(treeSize * 15, (treeSize * 15) + treeSize);
	this.fld_hbox_h_init = this.float_buffer_1.subarray(treeSize * 16, (treeSize * 16) + treeSize);
	this.fld_hbox_h_last = this.float_buffer_1.subarray(treeSize * 17, (treeSize * 17) + treeSize);
	this.fld_hbox___childsrendersize__ = this.int_buffer_1.subarray(treeSize * 20, (treeSize * 20) + treeSize);
	this.fld_hbox___childsrendersize___init = this.int_buffer_1.subarray(treeSize * 29, (treeSize * 29) + treeSize);
	this.fld_hbox___childsrendersize___last = this.int_buffer_1.subarray(treeSize * 30, (treeSize * 30) + treeSize);
	this.fld_hbox___draw__ = this.int_buffer_1.subarray(treeSize * 24, (treeSize * 24) + treeSize);
	this.fld_hbox___draw__0 = this.int_buffer_1.subarray(treeSize * 22, (treeSize * 22) + treeSize);
	this.fld_hbox___draw__1 = this.int_buffer_1.subarray(treeSize * 23, (treeSize * 23) + treeSize);
	this.fld_hbox___draw__2 = this.int_buffer_1.subarray(treeSize * 17, (treeSize * 17) + treeSize);
	this.fld_hbox___draw__3 = this.int_buffer_1.subarray(treeSize * 18, (treeSize * 18) + treeSize);
	this.fld_hbox___selfrendersize__ = this.int_buffer_1.subarray(treeSize * 25, (treeSize * 25) + treeSize);
	this.fld_hbox___selfrendersize__0 = this.int_buffer_1.subarray(treeSize * 21, (treeSize * 21) + treeSize);
	this.fld_hbox___selfrendersize__1 = this.int_buffer_1.subarray(treeSize * 19, (treeSize * 19) + treeSize);
	this.fld_hbox___selfrendersize__2 = this.int_buffer_1.subarray(treeSize * 16, (treeSize * 16) + treeSize);
	this.fld_hbox___selfrendersize__3 = this.int_buffer_1.subarray(treeSize * 15, (treeSize * 15) + treeSize);
	this.fld_hbox_w_init = this.float_buffer_1.subarray(treeSize * 8, (treeSize * 8) + treeSize);
	this.fld_hbox_w_last = this.float_buffer_1.subarray(treeSize * 9, (treeSize * 9) + treeSize);
	...
	this.fld_leaf_color = this.int_buffer_1.subarray(treeSize * 35, (treeSize * 35) + treeSize);
	this.fld_leaf___draw__ = this.int_buffer_1.subarray(treeSize * 38, (treeSize * 38) + treeSize);
	this.fld_leaf___draw__0 = this.int_buffer_1.subarray(treeSize * 37, (treeSize * 37) + treeSize);
	this.fld_leaf___selfrendersize__ = this.int_buffer_1.subarray(treeSize * 39, (treeSize * 39) + treeSize);
	this.fld_leaf___selfrendersize__0 = this.int_buffer_1.subarray(treeSize * 36, (treeSize * 36) + treeSize);
	...
	this.fld_root_child_child_count = this.int_buffer_1.subarray(treeSize * 14, (treeSize * 14) + treeSize);
	this.fld_root_child_child_leftmost_child = this.nodeindex_buffer_1.subarray(treeSize * 0, (treeSize * 0) + treeSize);
	this.fld_root___childrendersize__ = this.int_buffer_1.subarray(treeSize * 13, (treeSize * 13) + treeSize);
	this.fld_root___draw__ = this.int_buffer_1.subarray(treeSize * 11, (treeSize * 11) + treeSize);
	this.fld_root___selfrendersize__ = this.int_buffer_1.subarray(treeSize * 12, (treeSize * 12) + treeSize);
	this.fld_root___typeplaceholderdouble__ = this.double_buffer_1.subarray(treeSize * 0, (treeSize * 0) + treeSize);
	this.fld_root___typeplaceholderfloat__ = this.float_buffer_1.subarray(treeSize * 7, (treeSize * 7) + treeSize);
	this.fld_root___typeplaceholderint__ = this.int_buffer_1.subarray(treeSize * 10, (treeSize * 10) + treeSize);
...
this._gen_copyHostBuffers = function (data, treeSize){
	...
	for(var i = 0; i < data.double_buffer_1.length; i++) {
		this.double_buffer_1[i] = data.double_buffer_1[i];
	}
...
<<<<<<< HEAD
=======
	this.proxyData.fld_root___typeplaceholderdouble__ = new CLDataWrapper(this, this.fld_root___typeplaceholderdouble__, this.cl_double_buffer_1);
	this.proxyData.fld_root___typeplaceholderfloat__ = new CLDataWrapper(this, this.fld_root___typeplaceholderfloat__, this.cl_float_buffer_1);
	this.proxyData.fld_root___typeplaceholderint__ = new CLDataWrapper(this, this.fld_root___typeplaceholderint__, this.cl_int_buffer_1);
>>>>>>> cb720bb95318a2c622dd1dbb34734e9ef585806c
...
=======
		"__typePlaceholderFloat__"		, "color"		, "userInput"		, "__typePlaceholderInt__"		, "glBufferMacro"		, "refname"		, "display"		, "__typePlaceholderDouble__"	];
this.offsets = "enum unionvariants {TOK_CHILD = 5, TOK_ROOT = 10, TOK_IGNORE = 8, TOK_CHILDS = 6, TOK_LEAF = 9, TOK_UNDEFINED = 12, TOK_HBOX = 7, TOK_TEXTBOX = 11};\n\n// Generated code. Modifcation to this file will be lost on next code generation.\n\n/**\n * @file   cl_runner_generated_buffer_info.h\n * @author Superconductor v0.1\n * @date   07/07/2014 20:31:11\n * @brief  Contains macros needed to access fields within monolithic OpenCL\n * buffers.\n * \n * @warning Generated code. Modifcation to this file will be lost on next\n * code generation.\n *\n * This file defines several sets of macros intended for use with the \n * 'monolithic' OpenCL buffer scheme of superconductor. In short, monolithic\n * buffers are a way of packing multiple different fields (represented by\n * structure-split arrays) into a single OpenCL buffer so as to minimize the\n * number of arguments needed to be passed to OpenCL.\n *\n * The macros contained here are of three classes:\n * @li @c buffer_name_size The number of fields packed into buffer buffer_name.\n * @li @c NUM_BUFFERS The total number of buffers define herein.\n * @li @c fld_class_property(node_idx) Macro to access the specified property of\n * for the node at node_idx.\n */\n\n#define FLOAT_BUFFER_1_SIZE 18\n#define INT_BUFFER_1_SIZE 40\n#define GRAMMARTOKENS_BUFFER_1_SIZE 2\n#define DOUBLE_BUFFER_1_SIZE 1\n#define NODEINDEX_BUFFER_1_SIZE 6\n\n#define refname(node_idx) grammartokens_buffer_1[tree_size * 1 + node_idx]\n#define REFNAME_POSITION 1\n#define REFNAME_BUFFER grammartokens_buffer_1\n#define fld_root___selfrendersize__(node_idx) int_buffer_1[tree_size * 12 + node_idx]\n#define FLD_ROOT_USCOREUSCORESELFRENDERSIZEUSCOREUSCORE_POSITION 12\n#define FLD_ROOT_USCOREUSCORESELFRENDERSIZEUSCOREUSCORE_BUFFER int_buffer_1\n#define fld_node_rx(node_idx) float_buffer_1[tree_size * 4 + node_idx]\n#define FLD_NODE_RX_POSITION 4\n#define FLD_NODE_RX_BUFFER float_buffer_1\n#define fld_iroot_h(node_idx) float_buffer_1[tree_size * 1 + node_idx]\n#define FLD_IROOT_H_POSITION 1\n#define FLD_IROOT_H_BUFFER float_buffer_1\n#define fld_hbox___selfrendersize__0(node_idx) int_buffer_1[tree_size * 21 + node_idx]\n#define FLD_HBOX_USCOREUSCORESELFRENDERSIZEUSCOREUSCORE0_POSITION 21\n#define FLD_HBOX_USCOREUSCORESELFRENDERSIZEUSCOREUSCORE0_BUFFER int_buffer_1\n#define fld_hbox_childs_y_init(node_idx) float_buffer_1[tree_size * 14 + node_idx]\n#define FLD_HBOX_CHILDS_Y_INIT_POSITION 14\n#define FLD_HBOX_CHILDS_Y_INIT_BUFFER float_buffer_1\n#define fld_node_depth(node_idx) int_buffer_1[tree_size * 9 + node_idx]\n#define FLD_NODE_DEPTH_POSITION 9\n#define FLD_NODE_DEPTH_BUFFER int_buffer_1\n#define fld_iroot_w(node_idx) float_buffer_1[tree_size * 0 + node_idx]\n#define FLD_IROOT_W_POSITION 0\n#define FLD_IROOT_W_BUFFER float_buffer_1\n#define id(node_idx) nodeindex_buffer_1[tree_size * 5 + node_idx]\n#define ID_POSITION 5\n#define ID_BUFFER nodeindex_buffer_1\n#define fld_leaf_color(node_idx) int_buffer_1[tree_size * 35 + node_idx]\n#define FLD_LEAF_COLOR_POSITION 35\n#define FLD_LEAF_COLOR_BUFFER int_buffer_1\n#define fld_hbox___childsrendersize__(node_idx) int_buffer_1[tree_size * 20 + node_idx]\n#define FLD_HBOX_USCOREUSCORECHILDSRENDERSIZEUSCOREUSCORE_POSITION 20\n#define FLD_HBOX_USCOREUSCORECHILDSRENDERSIZEUSCOREUSCORE_BUFFER int_buffer_1\n#define fld_hbox_childs___dorenderinglast___init(node_idx) int_buffer_1[tree_size * 27 + node_idx]\n#define FLD_HBOX_CHILDS_USCOREUSCOREDORENDERINGLASTUSCOREUSCORE_INIT_POSITION 27\n#define FLD_HBOX_CHILDS_USCOREUSCOREDORENDERINGLASTUSCOREUSCORE_INIT_BUFFER int_buffer_1\n#define fld_hbox_childs___renderrightoffset___last(node_idx) int_buffer_1[tree_size * 34 + node_idx]\n#define FLD_HBOX_CHILDS_USCOREUSCORERENDERRIGHTOFFSETUSCOREUSCORE_LAST_POSITION 34\n#define FLD_HBOX_CHILDS_USCOREUSCORERENDERRIGHTOFFSETUSCOREUSCORE_LAST_BUFFER int_buffer_1\n#define fld_hbox_childs_x_init(node_idx) float_buffer_1[tree_size * 10 + node_idx]\n#define FLD_HBOX_CHILDS_X_INIT_POSITION 10\n#define FLD_HBOX_CHILDS_X_INIT_BUFFER float_buffer_1\n#define left_siblings(node_idx) nodeindex_buffer_1[tree_size * 3 + node_idx]\n#define LEFT_SIBLINGS_POSITION 3\n#define LEFT_SIBLINGS_BUFFER nodeindex_buffer_1\n#define fld_leaf___selfrendersize__(node_idx) int_buffer_1[tree_size * 39 + node_idx]\n#define FLD_LEAF_USCOREUSCORESELFRENDERSIZEUSCOREUSCORE_POSITION 39\n#define FLD_LEAF_USCOREUSCORESELFRENDERSIZEUSCOREUSCORE_BUFFER int_buffer_1\n#define fld_hbox___childsrendersize___last(node_idx) int_buffer_1[tree_size * 30 + node_idx]\n#define FLD_HBOX_USCOREUSCORECHILDSRENDERSIZEUSCOREUSCORE_LAST_POSITION 30\n#define FLD_HBOX_USCOREUSCORECHILDSRENDERSIZEUSCOREUSCORE_LAST_BUFFER int_buffer_1\n#define fld_hbox___selfrendersize__2(node_idx) int_buffer_1[tree_size * 16 + node_idx]\n#define FLD_HBOX_USCOREUSCORESELFRENDERSIZEUSCOREUSCORE2_POSITION 16\n#define FLD_HBOX_USCOREUSCORESELFRENDERSIZEUSCOREUSCORE2_BUFFER int_buffer_1\n#define fld_hbox_childs_depth_init(node_idx) int_buffer_1[tree_size * 31 + node_idx]\n#define FLD_HBOX_CHILDS_DEPTH_INIT_POSITION 31\n#define FLD_HBOX_CHILDS_DEPTH_INIT_BUFFER int_buffer_1\n#define fld_hbox___selfrendersize__3(node_idx) int_buffer_1[tree_size * 15 + node_idx]\n#define FLD_HBOX_USCOREUSCORESELFRENDERSIZEUSCOREUSCORE3_POSITION 15\n#define FLD_HBOX_USCOREUSCORESELFRENDERSIZEUSCOREUSCORE3_BUFFER int_buffer_1\n#define fld_root___typeplaceholderdouble__(node_idx) double_buffer_1[tree_size * 0 + node_idx]\n#define FLD_ROOT_USCOREUSCORETYPEPLACEHOLDERDOUBLEUSCOREUSCORE_POSITION 0\n#define FLD_ROOT_USCOREUSCORETYPEPLACEHOLDERDOUBLEUSCOREUSCORE_BUFFER double_buffer_1\n#define fld_root___childrendersize__(node_idx) int_buffer_1[tree_size * 13 + node_idx]\n#define FLD_ROOT_USCOREUSCORECHILDRENDERSIZEUSCOREUSCORE_POSITION 13\n#define FLD_ROOT_USCOREUSCORECHILDRENDERSIZEUSCOREUSCORE_BUFFER int_buffer_1\n#define fld_hbox___draw__0(node_idx) int_buffer_1[tree_size * 22 + node_idx]\n#define FLD_HBOX_USCOREUSCOREDRAWUSCOREUSCORE0_POSITION 22\n#define FLD_HBOX_USCOREUSCOREDRAWUSCOREUSCORE0_BUFFER int_buffer_1\n#define fld_hbox_w_last(node_idx) float_buffer_1[tree_size * 9 + node_idx]\n#define FLD_HBOX_W_LAST_POSITION 9\n#define FLD_HBOX_W_LAST_BUFFER float_buffer_1\n#define fld_node_h(node_idx) float_buffer_1[tree_size * 5 + node_idx]\n#define FLD_NODE_H_POSITION 5\n#define FLD_NODE_H_BUFFER float_buffer_1\n#define displayname(node_idx) grammartokens_buffer_1[tree_size * 0 + node_idx]\n#define DISPLAYNAME_POSITION 0\n#define DISPLAYNAME_BUFFER grammartokens_buffer_1\n#define fld_hbox_childs___dorenderinglast___last(node_idx) int_buffer_1[tree_size * 28 + node_idx]\n#define FLD_HBOX_CHILDS_USCOREUSCOREDORENDERINGLASTUSCOREUSCORE_LAST_POSITION 28\n#define FLD_HBOX_CHILDS_USCOREUSCOREDORENDERINGLASTUSCOREUSCORE_LAST_BUFFER int_buffer_1\n#define fld_leaf___draw__(node_idx) int_buffer_1[tree_size * 38 + node_idx]\n#define FLD_LEAF_USCOREUSCOREDRAWUSCOREUSCORE_POSITION 38\n#define FLD_LEAF_USCOREUSCOREDRAWUSCOREUSCORE_BUFFER int_buffer_1\n#define fld_root___typeplaceholderint__(node_idx) int_buffer_1[tree_size * 10 + node_idx]\n#define FLD_ROOT_USCOREUSCORETYPEPLACEHOLDERINTUSCOREUSCORE_POSITION 10\n#define FLD_ROOT_USCOREUSCORETYPEPLACEHOLDERINTUSCOREUSCORE_BUFFER int_buffer_1\n#define fld_node_x(node_idx) float_buffer_1[tree_size * 6 + node_idx]\n#define FLD_NODE_X_POSITION 6\n#define FLD_NODE_X_BUFFER float_buffer_1\n#define fld_node_w(node_idx) float_buffer_1[tree_size * 2 + node_idx]\n#define FLD_NODE_W_POSITION 2\n#define FLD_NODE_W_BUFFER float_buffer_1\n#define fld_root_child_child_leftmost_child(node_idx) nodeindex_buffer_1[tree_size * 0 + node_idx]\n#define FLD_ROOT_CHILD_CHILD_LEFTMOST_CHILD_POSITION 0\n#define FLD_ROOT_CHILD_CHILD_LEFTMOST_CHILD_BUFFER nodeindex_buffer_1\n#define fld_hbox_childs_x_last(node_idx) float_buffer_1[tree_size * 11 + node_idx]\n#define FLD_HBOX_CHILDS_X_LAST_POSITION 11\n#define FLD_HBOX_CHILDS_X_LAST_BUFFER float_buffer_1\n#define fld_hbox___draw__1(node_idx) int_buffer_1[tree_size * 23 + node_idx]\n#define FLD_HBOX_USCOREUSCOREDRAWUSCOREUSCORE1_POSITION 23\n#define FLD_HBOX_USCOREUSCOREDRAWUSCOREUSCORE1_BUFFER int_buffer_1\n#define fld_hbox_h_last(node_idx) float_buffer_1[tree_size * 17 + node_idx]\n#define FLD_HBOX_H_LAST_POSITION 17\n#define FLD_HBOX_H_LAST_BUFFER float_buffer_1\n#define fld_iroot___renderrightoffset__(node_idx) int_buffer_1[tree_size * 0 + node_idx]\n#define FLD_IROOT_USCOREUSCORERENDERRIGHTOFFSETUSCOREUSCORE_POSITION 0\n#define FLD_IROOT_USCOREUSCORERENDERRIGHTOFFSETUSCOREUSCORE_BUFFER int_buffer_1\n#define fld_node___renderoffset__(node_idx) int_buffer_1[tree_size * 6 + node_idx]\n#define FLD_NODE_USCOREUSCORERENDEROFFSETUSCOREUSCORE_POSITION 6\n#define FLD_NODE_USCOREUSCORERENDEROFFSETUSCOREUSCORE_BUFFER int_buffer_1\n#define fld_hbox_w_init(node_idx) float_buffer_1[tree_size * 8 + node_idx]\n#define FLD_HBOX_W_INIT_POSITION 8\n#define FLD_HBOX_W_INIT_BUFFER float_buffer_1\n#define fld_hbox_childs_depth_last(node_idx) int_buffer_1[tree_size * 32 + node_idx]\n#define FLD_HBOX_CHILDS_DEPTH_LAST_POSITION 32\n#define FLD_HBOX_CHILDS_DEPTH_LAST_BUFFER int_buffer_1\n#define fld_hbox___childsrendersize___init(node_idx) int_buffer_1[tree_size * 29 + node_idx]\n#define FLD_HBOX_USCOREUSCORECHILDSRENDERSIZEUSCOREUSCORE_INIT_POSITION 29\n#define FLD_HBOX_USCOREUSCORECHILDSRENDERSIZEUSCOREUSCORE_INIT_BUFFER int_buffer_1\n#define fld_iroot___rendersize__(node_idx) int_buffer_1[tree_size * 2 + node_idx]\n#define FLD_IROOT_USCOREUSCORERENDERSIZEUSCOREUSCORE_POSITION 2\n#define FLD_IROOT_USCOREUSCORERENDERSIZEUSCOREUSCORE_BUFFER int_buffer_1\n#define fld_iroot___dorenderinglast__(node_idx) int_buffer_1[tree_size * 3 + node_idx]\n#define FLD_IROOT_USCOREUSCOREDORENDERINGLASTUSCOREUSCORE_POSITION 3\n#define FLD_IROOT_USCOREUSCOREDORENDERINGLASTUSCOREUSCORE_BUFFER int_buffer_1\n#define fld_hbox___draw__(node_idx) int_buffer_1[tree_size * 24 + node_idx]\n#define FLD_HBOX_USCOREUSCOREDRAWUSCOREUSCORE_POSITION 24\n#define FLD_HBOX_USCOREUSCOREDRAWUSCOREUSCORE_BUFFER int_buffer_1\n#define right_siblings(node_idx) nodeindex_buffer_1[tree_size * 2 + node_idx]\n#define RIGHT_SIBLINGS_POSITION 2\n#define RIGHT_SIBLINGS_BUFFER nodeindex_buffer_1\n#define fld_hbox___draw__2(node_idx) int_buffer_1[tree_size * 17 + node_idx]\n#define FLD_HBOX_USCOREUSCOREDRAWUSCOREUSCORE2_POSITION 17\n#define FLD_HBOX_USCOREUSCOREDRAWUSCOREUSCORE2_BUFFER int_buffer_1\n#define fld_node___renderrightoffset__(node_idx) int_buffer_1[tree_size * 5 + node_idx]\n#define FLD_NODE_USCOREUSCORERENDERRIGHTOFFSETUSCOREUSCORE_POSITION 5\n#define FLD_NODE_USCOREUSCORERENDERRIGHTOFFSETUSCOREUSCORE_BUFFER int_buffer_1\n#define fld_root_child_child_count(node_idx) int_buffer_1[tree_size * 14 + node_idx]\n#define FLD_ROOT_CHILD_CHILD_COUNT_POSITION 14\n#define FLD_ROOT_CHILD_CHILD_COUNT_BUFFER int_buffer_1\n#define fld_leaf___draw__0(node_idx) int_buffer_1[tree_size * 37 + node_idx]\n#define FLD_LEAF_USCOREUSCOREDRAWUSCOREUSCORE0_POSITION 37\n#define FLD_LEAF_USCOREUSCOREDRAWUSCOREUSCORE0_BUFFER int_buffer_1\n#define fld_hbox_childs_rx_init(node_idx) float_buffer_1[tree_size * 12 + node_idx]\n#define FLD_HBOX_CHILDS_RX_INIT_POSITION 12\n#define FLD_HBOX_CHILDS_RX_INIT_BUFFER float_buffer_1\n#define fld_iroot___renderoffset__(node_idx) int_buffer_1[tree_size * 1 + node_idx]\n#define FLD_IROOT_USCOREUSCORERENDEROFFSETUSCOREUSCORE_POSITION 1\n#define FLD_IROOT_USCOREUSCORERENDEROFFSETUSCOREUSCORE_BUFFER int_buffer_1\n#define parent(node_idx) nodeindex_buffer_1[tree_size * 4 + node_idx]\n#define PARENT_POSITION 4\n#define PARENT_BUFFER nodeindex_buffer_1\n#define fld_leaf___selfrendersize__0(node_idx) int_buffer_1[tree_size * 36 + node_idx]\n#define FLD_LEAF_USCOREUSCORESELFRENDERSIZEUSCOREUSCORE0_POSITION 36\n#define FLD_LEAF_USCOREUSCORESELFRENDERSIZEUSCOREUSCORE0_BUFFER int_buffer_1\n#define fld_root___draw__(node_idx) int_buffer_1[tree_size * 11 + node_idx]\n#define FLD_ROOT_USCOREUSCOREDRAWUSCOREUSCORE_POSITION 11\n#define FLD_ROOT_USCOREUSCOREDRAWUSCOREUSCORE_BUFFER int_buffer_1\n#define fld_node___rendersize__(node_idx) int_buffer_1[tree_size * 7 + node_idx]\n#define FLD_NODE_USCOREUSCORERENDERSIZEUSCOREUSCORE_POSITION 7\n#define FLD_NODE_USCOREUSCORERENDERSIZEUSCOREUSCORE_BUFFER int_buffer_1\n#define fld_hbox___selfrendersize__1(node_idx) int_buffer_1[tree_size * 19 + node_idx]\n#define FLD_HBOX_USCOREUSCORESELFRENDERSIZEUSCOREUSCORE1_POSITION 19\n#define FLD_HBOX_USCOREUSCORESELFRENDERSIZEUSCOREUSCORE1_BUFFER int_buffer_1\n#define fld_hbox___selfrendersize__(node_idx) int_buffer_1[tree_size * 25 + node_idx]\n#define FLD_HBOX_USCOREUSCORESELFRENDERSIZEUSCOREUSCORE_POSITION 25\n#define FLD_HBOX_USCOREUSCORESELFRENDERSIZEUSCOREUSCORE_BUFFER int_buffer_1\n#define fld_node_y(node_idx) float_buffer_1[tree_size * 3 + node_idx]\n#define FLD_NODE_Y_POSITION 3\n#define FLD_NODE_Y_BUFFER float_buffer_1\n#define fld_root___typeplaceholderfloat__(node_idx) float_buffer_1[tree_size * 7 + node_idx]\n#define FLD_ROOT_USCOREUSCORETYPEPLACEHOLDERFLOATUSCOREUSCORE_POSITION 7\n#define FLD_ROOT_USCOREUSCORETYPEPLACEHOLDERFLOATUSCOREUSCORE_BUFFER float_buffer_1\n#define fld_hbox_childs_rx_last(node_idx) float_buffer_1[tree_size * 13 + node_idx]\n#define FLD_HBOX_CHILDS_RX_LAST_POSITION 13\n#define FLD_HBOX_CHILDS_RX_LAST_BUFFER float_buffer_1\n#define fld_hbox___draw__3(node_idx) int_buffer_1[tree_size * 18 + node_idx]\n#define FLD_HBOX_USCOREUSCOREDRAWUSCOREUSCORE3_POSITION 18\n#define FLD_HBOX_USCOREUSCOREDRAWUSCOREUSCORE3_BUFFER int_buffer_1\n#define fld_hbox_h_init(node_idx) float_buffer_1[tree_size * 16 + node_idx]\n#define FLD_HBOX_H_INIT_POSITION 16\n#define FLD_HBOX_H_INIT_BUFFER float_buffer_1\n#define fld_node___dorenderinglast__(node_idx) int_buffer_1[tree_size * 8 + node_idx]\n#define FLD_NODE_USCOREUSCOREDORENDERINGLASTUSCOREUSCORE_POSITION 8\n#define FLD_NODE_USCOREUSCOREDORENDERINGLASTUSCOREUSCORE_BUFFER int_buffer_1\n#define fld_hbox_child_childs_count(node_idx) int_buffer_1[tree_size * 26 + node_idx]\n#define FLD_HBOX_CHILD_CHILDS_COUNT_POSITION 26\n#define FLD_HBOX_CHILD_CHILDS_COUNT_BUFFER int_buffer_1\n#define fld_hbox_childs___renderrightoffset___init(node_idx) int_buffer_1[tree_size * 33 + node_idx]\n#define FLD_HBOX_CHILDS_USCOREUSCORERENDERRIGHTOFFSETUSCOREUSCORE_INIT_POSITION 33\n#define FLD_HBOX_CHILDS_USCOREUSCORERENDERRIGHTOFFSETUSCOREUSCORE_INIT_BUFFER int_buffer_1\n#define fld_hbox_childs_y_last(node_idx) float_buffer_1[tree_size * 15 + node_idx]\n#define FLD_HBOX_CHILDS_Y_LAST_POSITION 15\n#define FLD_HBOX_CHILDS_Y_LAST_BUFFER float_buffer_1\n#define fld_iroot_userinput(node_idx) int_buffer_1[tree_size * 4 + node_idx]\n#define FLD_IROOT_USERINPUT_POSITION 4\n#define FLD_IROOT_USERINPUT_BUFFER int_buffer_1\n#define fld_hbox_child_childs_leftmost_child(node_idx) nodeindex_buffer_1[tree_size * 1 + node_idx]\n#define FLD_HBOX_CHILD_CHILDS_LEFTMOST_CHILD_POSITION 1\n#define FLD_HBOX_CHILD_CHILDS_LEFTMOST_CHILD_BUFFER nodeindex_buffer_1\n";
>>>>>>> cb720bb95318a2c622dd1dbb34734e9ef585806c
...
=======
this.visit_leaf_0 = function (index, tree_size,  float_buffer_1,  int_buffer_1,  grammartokens_buffer_1,  double_buffer_1,  nodeindex_buffer_1) {
>>>>>>> cb720bb95318a2c622dd1dbb34734e9ef585806c
...
=======
this.visit_hbox_0 = function (index, tree_size,  float_buffer_1,  int_buffer_1,  grammartokens_buffer_1,  double_buffer_1,  nodeindex_buffer_1) {
>>>>>>> cb720bb95318a2c622dd1dbb34734e9ef585806c
...
=======
this.visit_root_0 = function (index, tree_size,  float_buffer_1,  int_buffer_1,  grammartokens_buffer_1,  double_buffer_1,  nodeindex_buffer_1) {
>>>>>>> cb720bb95318a2c622dd1dbb34734e9ef585806c
...
=======
this.visit_leaf_1 = function (index, tree_size,  float_buffer_1,  int_buffer_1,  grammartokens_buffer_1,  double_buffer_1,  nodeindex_buffer_1) {
>>>>>>> cb720bb95318a2c622dd1dbb34734e9ef585806c
...
=======
this.visit_hbox_1 = function (index, tree_size,  float_buffer_1,  int_buffer_1,  grammartokens_buffer_1,  double_buffer_1,  nodeindex_buffer_1) {
>>>>>>> cb720bb95318a2c622dd1dbb34734e9ef585806c
...
=======
this.visit_root_1 = function (index, tree_size,  float_buffer_1,  int_buffer_1,  grammartokens_buffer_1,  double_buffer_1,  nodeindex_buffer_1) {
>>>>>>> cb720bb95318a2c622dd1dbb34734e9ef585806c
...
=======
this.visit_leaf_2 = function (index, tree_size,  float_buffer_1,  int_buffer_1,  grammartokens_buffer_1,  double_buffer_1,  nodeindex_buffer_1) {
>>>>>>> cb720bb95318a2c622dd1dbb34734e9ef585806c
...
=======
this.visit_hbox_2 = function (index, tree_size,  float_buffer_1,  int_buffer_1,  grammartokens_buffer_1,  double_buffer_1,  nodeindex_buffer_1) {
>>>>>>> cb720bb95318a2c622dd1dbb34734e9ef585806c
...
=======
this.visit_root_2 = function (index, tree_size,  float_buffer_1,  int_buffer_1,  grammartokens_buffer_1,  double_buffer_1,  nodeindex_buffer_1) {
>>>>>>> cb720bb95318a2c622dd1dbb34734e9ef585806c
...
=======
this.visit_leaf_3 = function (index, tree_size,  float_buffer_1,  int_buffer_1,  grammartokens_buffer_1,  double_buffer_1,  nodeindex_buffer_1) {
>>>>>>> cb720bb95318a2c622dd1dbb34734e9ef585806c
...
=======
this.visit_hbox_3 = function (index, tree_size,  float_buffer_1,  int_buffer_1,  grammartokens_buffer_1,  double_buffer_1,  nodeindex_buffer_1) {
>>>>>>> cb720bb95318a2c622dd1dbb34734e9ef585806c
...
=======
this.visit_root_3 = function (index, tree_size,  float_buffer_1,  int_buffer_1,  grammartokens_buffer_1,  double_buffer_1,  nodeindex_buffer_1) {
>>>>>>> cb720bb95318a2c622dd1dbb34734e9ef585806c
...
=======
this.visit_leaf_4 = function (index, tree_size,  float_buffer_1,  int_buffer_1,  grammartokens_buffer_1,  double_buffer_1,  nodeindex_buffer_1,  glBuffer) {
>>>>>>> cb720bb95318a2c622dd1dbb34734e9ef585806c
...
=======
this.visit_hbox_4 = function (index, tree_size,  float_buffer_1,  int_buffer_1,  grammartokens_buffer_1,  double_buffer_1,  nodeindex_buffer_1,  glBuffer) {
>>>>>>> cb720bb95318a2c622dd1dbb34734e9ef585806c
...
=======
this.visit_root_4 = function (index, tree_size,  float_buffer_1,  int_buffer_1,  grammartokens_buffer_1,  double_buffer_1,  nodeindex_buffer_1,  glBuffer) {
>>>>>>> cb720bb95318a2c622dd1dbb34734e9ef585806c
...
=======
this.visit_0 = function (index, tree_size,  float_buffer_1,  int_buffer_1,  grammartokens_buffer_1,  double_buffer_1,  nodeindex_buffer_1) {

	switch(this.displayname[index]) {
		case this.TOK_ROOT:
			this.visit_root_0(index, tree_size, float_buffer_1, int_buffer_1, grammartokens_buffer_1, double_buffer_1, nodeindex_buffer_1);
			break;
		case this.TOK_HBOX:
			this.visit_hbox_0(index, tree_size, float_buffer_1, int_buffer_1, grammartokens_buffer_1, double_buffer_1, nodeindex_buffer_1);
			break;
		case this.TOK_LEAF:
			this.visit_leaf_0(index, tree_size, float_buffer_1, int_buffer_1, grammartokens_buffer_1, double_buffer_1, nodeindex_buffer_1);
			break;
	}
}
this.visit_1 = function (index, tree_size,  float_buffer_1,  int_buffer_1,  grammartokens_buffer_1,  double_buffer_1,  nodeindex_buffer_1) {

	switch(this.displayname[index]) {
		case this.TOK_ROOT:
			this.visit_root_1(index, tree_size, float_buffer_1, int_buffer_1, grammartokens_buffer_1, double_buffer_1, nodeindex_buffer_1);
			break;
		case this.TOK_HBOX:
			this.visit_hbox_1(index, tree_size, float_buffer_1, int_buffer_1, grammartokens_buffer_1, double_buffer_1, nodeindex_buffer_1);
			break;
		case this.TOK_LEAF:
			this.visit_leaf_1(index, tree_size, float_buffer_1, int_buffer_1, grammartokens_buffer_1, double_buffer_1, nodeindex_buffer_1);
			break;
	}
}
this.visit_2 = function (index, tree_size,  float_buffer_1,  int_buffer_1,  grammartokens_buffer_1,  double_buffer_1,  nodeindex_buffer_1) {

	switch(this.displayname[index]) {
		case this.TOK_ROOT:
			this.visit_root_2(index, tree_size, float_buffer_1, int_buffer_1, grammartokens_buffer_1, double_buffer_1, nodeindex_buffer_1);
			break;
		case this.TOK_HBOX:
			this.visit_hbox_2(index, tree_size, float_buffer_1, int_buffer_1, grammartokens_buffer_1, double_buffer_1, nodeindex_buffer_1);
			break;
		case this.TOK_LEAF:
			this.visit_leaf_2(index, tree_size, float_buffer_1, int_buffer_1, grammartokens_buffer_1, double_buffer_1, nodeindex_buffer_1);
			break;
	}
}
this.visit_3 = function (index, tree_size,  float_buffer_1,  int_buffer_1,  grammartokens_buffer_1,  double_buffer_1,  nodeindex_buffer_1) {

	switch(this.displayname[index]) {
		case this.TOK_ROOT:
			this.visit_root_3(index, tree_size, float_buffer_1, int_buffer_1, grammartokens_buffer_1, double_buffer_1, nodeindex_buffer_1);
			break;
		case this.TOK_HBOX:
			this.visit_hbox_3(index, tree_size, float_buffer_1, int_buffer_1, grammartokens_buffer_1, double_buffer_1, nodeindex_buffer_1);
			break;
		case this.TOK_LEAF:
			this.visit_leaf_3(index, tree_size, float_buffer_1, int_buffer_1, grammartokens_buffer_1, double_buffer_1, nodeindex_buffer_1);
			break;
	}
}
this.visit_4 = function (index, tree_size,  float_buffer_1,  int_buffer_1,  grammartokens_buffer_1,  double_buffer_1,  nodeindex_buffer_1,  glBuffer) {

	switch(this.displayname[index]) {
		case this.TOK_ROOT:
			this.visit_root_4(index, tree_size, float_buffer_1, int_buffer_1, grammartokens_buffer_1, double_buffer_1, nodeindex_buffer_1, glBuffer);
			break;
		case this.TOK_HBOX:
			this.visit_hbox_4(index, tree_size, float_buffer_1, int_buffer_1, grammartokens_buffer_1, double_buffer_1, nodeindex_buffer_1, glBuffer);
			break;
		case this.TOK_LEAF:
			this.visit_leaf_4(index, tree_size, float_buffer_1, int_buffer_1, grammartokens_buffer_1, double_buffer_1, nodeindex_buffer_1, glBuffer);
>>>>>>> cb720bb95318a2c622dd1dbb34734e9ef585806c
			break;
	}
}
