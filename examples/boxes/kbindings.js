...
this._gen_allocateClBuffers = function() {
	...
	this.cl_double_buffer_1 = this.context.createBuffer(this.cl.MEM_READ_WRITE, this.double_buffer_1.byteLength);
...
this._gen_transferTree = function() {
	...
	this.queue.enqueueWriteBuffer(this.cl_double_buffer_1, true, 0, this.double_buffer_1.byteLength, this.double_buffer_1);
...
this._gen_retrieveTree = function() {
	...
	this.queue.enqueueReadBuffer(this.cl_double_buffer_1, true, 0, this.double_buffer_1.byteLength, this.double_buffer_1);
...
if (!this.cfg.nodeCL && typeof webcl.enableExtension == "function") {
	...
	kernel.setArg(5, this.cl_double_buffer_1);
	kernel.setArg(6, this.cl_nodeindex_buffer_1);
};
...
this._gen_run_visit_4 = function(clVBO) {
	...
	this._gen_kernel_visit_4.setArg(7, clVBO);
