...
function visit_listbox_4(node) {
  ...
  logger.log("    last init render: " + getAttribSafe(node, "render"));
    ...
    for (var i = 0; i < children.length; i++) {
      var child = children[i]; 
      setAttribSafe(node, "render", (paintLine(getAttribSafe(node, "x") + 5, getAttribSafe(child, "absy"), getAttribSafe(node, "x") + 10, getAttribSafe(child, "absy"), "#777") + paintLine(getAttribSafe(node, "x") + 10, getAttribSafe(child, "absy"), getAttribSafe(node, "x") + 10, getAttribSafe(child, "absy") + 5, "#777") + paintLine(getAttribSafe(node, "x") + 10, getAttribSafe(child, "absy") + 5, getAttribSafe(node, "x") + 5, getAttribSafe(child, "absy") + 5, "#777") + paintLine(getAttribSafe(node, "x") + 5, getAttribSafe(child, "absy") + (+ 5), getAttribSafe(node, "x") + 5, getAttribSafe(child, "absy"), "#777")));
